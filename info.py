...
USERNAME = environ.get('USERNAME', "https://t.me/Mr_NotPerfect") # ADMIN USERNAME
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002160880207 -1002055127272').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
...
PAYPICS = (environ.get('PAYPICS', 'https://telegra.ph/file/ffd0ce0182b0b94c57c53.jpg')).split()
