...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Strangerthing50') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
...
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'adsfly.im')
