...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        m = await query.message.reply_sticker(
            "CAACAgQAAxkBAAEiLZ9l7VMuTY7QHn4edR6ouHUosQQ9gwACFxIAArzT-FOmYU0gLeJu7x4E"
        )
        await m.delete()
        ...
        buttons = [
            [
                InlineKeyboardButton(
                    "☆📸 𝙎𝙚𝙣𝙙 𝙨𝙘𝙧𝙚𝙚𝙣𝙨𝙝𝙤𝙩 📸☆", url=f"https://t.me/FilmcityQuery_bot"
                )
            ],
    ...
    # )
        ...
        buttons = [
            [InlineKeyboardButton("Repo", url="https://t.me/FilmcityQuery_bot")],
            [
